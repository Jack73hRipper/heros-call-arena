...
export const SOUND_KEYS = {
  ...
  SKILL_GRASP_OF_THE_GRAVE: 'skill_grasp_of_the_grave',
  SKILL_DEATHS_EMBRACE: 'skill_deaths_embrace',
  SKILL_UNDYING_FURY: 'skill_undying_fury',
  SKILL_UNDYING_FURY_TRIGGER: 'skill_undying_fury_trigger',
  SKILL_SOUL_REND: 'skill_soul_rend',
  SKILL_SOUL_REND_EMPOWERED: 'skill_soul_rend_empowered',
