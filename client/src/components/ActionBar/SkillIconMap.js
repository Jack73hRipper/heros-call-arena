...
const SKILL_SPRITE_MAP = {
  ...
  // Phase 25R: Revenant reworked skills
  grasp_of_the_grave: null,  // No atlas entry yet — uses emoji fallback
  deaths_embrace:     null,  // No atlas entry yet — uses emoji fallback
  soul_rend:          null,  // No atlas entry yet — uses emoji fallback
  undying_fury:       null,  // No atlas entry yet — uses emoji fallback
};
